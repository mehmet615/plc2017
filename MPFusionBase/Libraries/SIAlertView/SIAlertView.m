...
- (id)initWithTitle:(NSString *)title andMessage:(NSString *)message
{
	...
	if (self) {
        ...
        self.containerWidth = UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad ? 600 : 300;
	}
	return self;
}
...
#endif
                                actualFontSize:nil
                                      forWidth:self.containerWidth /*CONTAINER_WIDTH*/ - CONTENT_PADDING_LEFT * 2
...
- (CGFloat)heightForMessageLabel
{
    ...
    if (self.messageLabel) {
        ...
        CGSize size = [self.message sizeWithFont:self.messageLabel.font
                               constrainedToSize:CGSizeMake(self.containerWidth /*CONTAINER_WIDTH*/ - CONTENT_PADDING_LEFT * 2, maxHeight)

//
//  MTPCoreDataInitializationHelper.m
...
@interface MTPCoreDataInitializationHelper ()
@property (nonatomic, strong) NSString *managedObjectModelName;
@property (nonatomic, strong) NSString *sqlLiteStoreName;
@end

@implementation MTPCoreDataInitializationHelper
                               ...
                               sqliteStoreName:(NSString *)sqliteStoreName
{
    ...
    if (self) {
        ...
        _sqlLiteStoreName = sqliteStoreName;
    }
    return self;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.MeetingPlay.MeetingPlayiBeaconStarter" in the application's documents directory.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    if (![_persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeURL options:options error:&error]) {
        ...
        error = [NSError errorWithDomain:[NSURLSession bundleIdentifier] code:9999 userInfo:dict];
